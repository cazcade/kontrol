...
public class HackedSSLSocketFactory implements LayeredSchemeSocketFactory, LayeredSocketFactory {
    ...
    /**
     * @deprecated Use {@link #HackedSSLSocketFactory(String, java.security.KeyStore, String, java.security.KeyStore, java.security.SecureRandom, X509HostnameVerifier)}
     */
    @Deprecated
